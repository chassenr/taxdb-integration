...
rule download_gtdb_uba:
	...
	shell:
		...
		tar -xzvf "{params.outdir}/genomes_uba/gtdb_uba_mags_arc.tar.gz" -C "{params.outdir}/genomes_uba"
		tar -xzvf "{params.outdir}/genomes_uba/gtdb_uba_mags.tar.gz" -C "{params.outdir}/genomes_uba"
